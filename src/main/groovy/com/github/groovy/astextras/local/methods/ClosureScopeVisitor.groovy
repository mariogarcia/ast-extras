...
/**
 * Created by mario on 03/06/14.
 */
class ClosureScopeVisitor implements GroovyCodeVisitor {
    @Override
    ...
    void visitClosureExpression(ClosureExpression closureExpression) {
        println "closure-->" + closureExpression.getVariableScope().getReferencedLocalVariable('x')
    }

    @Override
    void visitTupleExpression(TupleExpression expressions) {
    ...
    @Override
    void visitArgumentlistExpression(ArgumentListExpression expressions) {

    }

    @Override
    void visitClosureListExpression(ClosureListExpression closureListExpression) {
        println "ClosureListExpression"
    }
